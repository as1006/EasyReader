...
import com.kroraina.easyreader.model.bean.packages.BillBookPackage;
import com.kroraina.easyreader.model.bean.packages.BookChapterPackage;
import com.kroraina.easyreader.model.bean.packages.BookCommentPackage;
import com.kroraina.easyreader.model.bean.packages.BookHelpsPackage;
import com.kroraina.easyreader.model.bean.packages.BookListDetailPackage;
import com.kroraina.easyreader.model.bean.packages.BookListPackage;
import com.kroraina.easyreader.model.bean.packages.BookReviewPackage;
import com.kroraina.easyreader.model.bean.packages.BookSubSortPackage;
import com.kroraina.easyreader.model.bean.packages.BookTagPackage;
import com.kroraina.easyreader.model.bean.packages.ChapterInfoPackage;
import com.kroraina.easyreader.model.bean.packages.CommentDetailPackage;
import com.kroraina.easyreader.model.bean.packages.CommentsPackage;
import com.kroraina.easyreader.model.bean.packages.HelpsDetailPackage;
import com.kroraina.easyreader.model.bean.packages.HotCommentPackage;
...
import com.kroraina.easyreader.model.bean.packages.RecommendBookListPackage;
import com.kroraina.easyreader.model.bean.packages.RecommendBookPackage;
import com.kroraina.easyreader.model.bean.packages.ReviewDetailPackage;
import com.kroraina.easyreader.model.bean.packages.SortBookPackage;
import com.kroraina.easyreader.model.bean.packages.TagSearchPackage;
...
public interface BookApi {
     ...
     */
    @GET("/post/by-book")
    Single<HotCommentPackage> getCommnentDiscuzPackage(@Query("book") String book,@Query("start") int start);
    ...
    Single<HotCommentPackage> getCommnentPackage(@Query("book") String book,@Query("start") int start);
     ...
     * @param start
     */
    @GET("/post/short-review/by-book")
    Single<HotCommentPackage> getShortCommnentPackage(@Query("book") String book,@Query("start") int start);
    ...
    @GET("/post/by-book")
    Single<BookDiscussPackage> getBookDiscussList(@Query("book") String bookId, @Query("sort") String sort, @Query("start") String start, @Query("limit") String limit);

    @GET("/post/review/by-book")
    Single<com.kroraina.easyreader.modules.community.comment.BookCommentPackage> getBookCommentList(@Query("book") String bookId, @Query("sort") String sort, @Query("start") String start, @Query("limit") String limit);

    @GET("/post/short-review/by-book")
    Single<BookShortCommentPackage> getBookShortCommentList(@Query("book") String bookId, @Query("sort") String sort, @Query("start") String start, @Query("limit") String limit);
