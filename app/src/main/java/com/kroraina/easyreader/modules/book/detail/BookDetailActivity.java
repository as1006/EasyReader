...
import com.kroraina.easyreader.modules.community.DiscussActivity;
...
@ActivityUI(layoutId = R.layout.activity_book_detail)
public class BookDetailActivity extends BaseMVPActivity<BookDetailContract.Presenter>
    ...
    protected void initClick() {
        ...
        mRvCommunity.setOnClickListener(v -> DiscussActivity.launch(BookDetailActivity.this,mBookId));
    }
    ...
    public void finishHotComment(List<HotCommentBean> beans) {
        ...
        mHotCommentAdapter.addItems(HotCommentItem.initFrom(this,beans));
        mHotCommentAdapter.notifyDataSetChanged();
    }

    @Override
    public void finishRecommendBookList(List<BookDetailRecommendListBean> beans) {
        if (beans.isEmpty()) {
        ...
        mBookListAdapter.addItems(BookDetailRecommendItem.initFrom(this,beans));
