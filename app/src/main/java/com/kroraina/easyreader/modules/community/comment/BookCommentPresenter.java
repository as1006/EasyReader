...
public class BookCommentPresenter extends RxPresenter<BookCommentContact.View> implements BookCommentContact.Presenter{
    ...
    public void firstLoading(String bookId,BookSort sort, int start, int limited) {
        Single<List<BookCommentBean>> remoteObserver = RemoteRepository.getInstance()
                .getBookComment(bookId, sort.getNetName(),start, limited);
