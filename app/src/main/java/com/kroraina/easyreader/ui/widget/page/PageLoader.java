...
public abstract class PageLoader {
    ...
    private void drawBackground(Bitmap bitmap, boolean isUpdate) {
        ...
        if (!isUpdate) {
            ...
            if (!mChapterList.isEmpty()) {
                ...
                tipTop += StatusBarCompat.getStatusBarHeight(mContext);
                //根据状态不一样，数据不一样
    ...
    private void drawContent(Bitmap bitmap) {
        ...
        if (mStatus != STATUS_FINISH) {
            ...
            if (mPageMode == PageMode.SCROLL) {
                ...
                top = StatusBarCompat.getStatusBarHeight(mContext) + mMarginHeight - mTextPaint.getFontMetrics().top;
            }
    ...
    void prepareDisplay(int w, int h) {
        ...
        mVisibleHeight = mDisplayHeight - mMarginHeight * 2 - StatusBarCompat.getStatusBarHeight(mContext);
