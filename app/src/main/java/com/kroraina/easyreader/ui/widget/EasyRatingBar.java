package com.kroraina.easyreader.ui.widget;
...
public class EasyRatingBar extends View {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        mInterval = (int) a.getDimension(R.styleable.EasyRatingBar_rateInterval,SizeUtils.dp2px(4));
    ...
    private int getInitRoomHeight(){
        ...
        return Math.min(SizeUtils.dp2px(DEFAULT_MAX_HEIGHT),drawableMin);
    }
